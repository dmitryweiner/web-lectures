...
```
* Свойство иммутабельно, менять бесполезно.
---
...
* Есть методы массива, не изменяющие сам массив, но возвращающие новый:
  * `slice, map, filter, find, findIndex, every, some, reduce, forEach, concat`.
---
...
```
* У них отличается **смысл аргументов**.
---
...
* Дан массив объектов, вернуть только isDone: true.
```js
[{id: 1, idDone: true}, {id: 2, idDone: false}, {id: 3, idDone: true}]
```